...
export default function EditProduct({ merchant, product }: Props) {
  ...
  const submit: FormEventHandler = (e) => {
    ...
    router.put(`/kasir/products/${product.produk_id}`, data, {
      onSuccess: () => {
  ...
  return (
    <KasirLayout 
      title="Edit Product - Kasir Portal"
      breadcrumbs={[
        { title: 'Products', href: '/kasir/products' },
        { title: 'Edit Product', href: `/kasir/products/${product.produk_id}/edit` }
      ]}
    >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Update product information for {merchant.nama}
            </p>
          </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    ...
                    <Button 
                      type="button" 
                      variant="outline" 
                      onClick={() => router.get('/kasir/products')}
                    >
                      Cancel
                    </Button>
                  </div>
